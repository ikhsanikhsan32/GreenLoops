...
import { CheckCircle, Upload, Loader, FileImage, BarChart, Tag, List, Trash2 } from 'lucide-react';
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="aspect-video bg-muted rounded-lg flex items-center justify-center relative overflow-hidden">
            {photoDataUri ? (
              <Image src={photoDataUri} alt="Briquette preview" fill objectFit="contain" />
            ) : (
